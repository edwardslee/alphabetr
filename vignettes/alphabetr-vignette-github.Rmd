...
We've spent a lot of time trying to develop a TCR sequencing approach that is more scaleable than single-cell sequencing, and the aim of
this vignette is to be clear and transparent in showing how we thought to solve this problem.
We don't claim that our approach is an be-all panacea for our sequencing woes, but we think it is one step towards moving the field closer to a gold standard in TCR sequencing.
The main purpose of this vignette is to demonstrate how to obtain the results of our paper^[Paper was submitted recently] and how to do simulations of your own.
