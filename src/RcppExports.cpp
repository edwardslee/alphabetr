...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(dual_discrim_dual_likelihood(est, err, numb_cells, numb_wells, binomials));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(dual_discrim_shared_likelihood(est1, est2, err, numb_cells, numb_wells, binomials, multinomials));
    return __result;
END_RCPP
}
// likelihood_dual
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(likelihood_dual(est, err, numb_wells, numb_cells, numb_sample));
    return __result;
END_RCPP
}
// likelihood_dualdual
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type numb_cells(numb_cellsSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type numb_sample(numb_sampleSEXP);
    __result = Rcpp::wrap(likelihood_single(est, err, numb_wells, numb_cells, numb_sample));
    return __result;
END_RCPP
}
